/*  graph_With_dftAtVertex.h
	Thomas Krumwiede
	12/2/24
	The graph declaration required for Assignment 2 problem 1*/
#pragma once
...
public:
    ...
    double dftAtVertex_(int vertex);
      
	//Function to perform the breadth first traversal of
	//the entire graph.
	double breadthFirstTraversal();
	...
	void getAdjacentVertices(int vIndex, list<pair<int, double>> &adjacencyList,
                                                 int& length);
